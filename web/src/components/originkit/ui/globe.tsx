...
export default function Globe({
    ...
    useEffect(() => {
        ...
        const loadWorldData = async () => {
            try {
                setIsLoading(true);
                // Geometría servida desde el propio proyecto. El componente
                // venía pidiéndola a raw.githubusercontent.com en cada carga:
                // el globo dependía de una red ajena para dibujarse, tardaba lo
                // que tardara GitHub y no existía sin conexión. Es el mismo
                // Natural Earth 50m, copiado a `public/geo/`.
                const response = await fetch(
                    "/geo/ne_50m_land.json"
                );
                ...
                if (showOutline && outlineColor && outlineRgba.a > 0) {
                    ...
                    // Traza de desarrollo del componente de OriginKit. En producción
                    // no aporta nada al visitante y ensucia la consola.
