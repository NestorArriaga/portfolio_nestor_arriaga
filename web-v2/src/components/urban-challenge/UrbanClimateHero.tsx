...
export default function UrbanClimateHero() {
  const { shortTitle } = urbanClimate;
  const asset = urbanAssets.find(a => a.id === "project-15-climate-reading-full");
