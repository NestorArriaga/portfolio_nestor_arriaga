...
export default function GranularSystemLimitations() {
  const { limitations } = granularSystem;

  return (
    <section id="alcance-sistema" className="w-full py-24 md:py-32 flex flex-col gap-12 border-b border-white/10">
