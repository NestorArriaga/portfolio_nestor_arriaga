...
export default function GranularPolicyLimitations() {
  const { limitations } = granularPolicy;

  return (
    <section id="alcance-politica-publica" className="w-full py-24 md:py-32 flex flex-col gap-12 border-b border-white/10">
