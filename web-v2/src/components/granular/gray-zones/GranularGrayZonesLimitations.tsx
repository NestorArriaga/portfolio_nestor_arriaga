...
export default function GranularGrayZonesLimitations() {
  const { limitations } = granularGrayZones;

  return (
    <section id="alcance-zonas-grises" className="w-full py-24 md:py-32 flex flex-col gap-12 border-b border-white/10">
