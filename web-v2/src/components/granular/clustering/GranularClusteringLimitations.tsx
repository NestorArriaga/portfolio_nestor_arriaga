...
export default function GranularClusteringLimitations() {
  const { limitations } = granularClustering;

  return (
    <section id="alcance-clustering" className="w-full py-24 md:py-32 flex flex-col gap-12 border-b border-white/10">
