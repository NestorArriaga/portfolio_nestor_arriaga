...
export default function GranularSocioeconomyToEnvironment() {
  const { nextChapterPreview } = granularSocioeconomy;
    ...
    <section className="w-full py-24 md:py-32 flex flex-col gap-12">
      ...
      <div className="flex flex-col gap-8 px-6 md:px-0">
        ...
        <div className="flex items-center gap-4">
          <span className="text-mono text-[10px] text-[var(--granular-dim-environment)] uppercase tracking-widest bg-[var(--granular-dim-environment)]/10 px-3 py-1 rounded-full border border-[var(--granular-dim-environment)]/20">
        ...
        <h3 className="text-display-md text-white">
          ...
          <span className="block text-[var(--granular-dim-environment)]">{nextChapterPreview.title}</span>
        </h3>
        ...
        <div className="mt-8">
           <Link 
             href="/projects/granular-comarca-lagunera#ambiente"
             className="inline-flex items-center gap-3 text-mono text-[11px] text-white bg-white/5 hover:bg-white/10 px-6 py-4 rounded-[var(--radius-panel)] transition-colors border border-white/10 hover:border-[var(--granular-dim-environment)]/50"
           >
