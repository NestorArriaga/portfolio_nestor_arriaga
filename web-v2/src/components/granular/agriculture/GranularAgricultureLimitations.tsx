...
export default function GranularAgricultureLimitations() {
  const { limitations } = granularAgriculture;

  return (
    <section id="alcance-agricultura" className="w-full py-24 md:py-32 flex flex-col gap-8 border-b border-white/10">
