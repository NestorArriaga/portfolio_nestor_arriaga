...
export default function GranularLocalitiesLimitations() {
  const { limitations } = granularLocalities;

  return (
    <section id="alcance-localidades" className="w-full py-24 md:py-32 flex flex-col gap-12 border-b border-white/10">
