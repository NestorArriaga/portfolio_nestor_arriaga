...
export default function MetztitlanReadings({ activeId, readings }: { activeId: string, readings: Reading[] }) {
  return (
    <section className="w-full bg-[#050505] py-32 border-t border-white/10">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        
        <Reveal direction="up" className="text-center mb-16">
          <h2 className="text-display-sm text-white mb-4">METZTITLÁN</h2>
          <div className="text-mono text-[10px] text-[var(--color-accent)] uppercase tracking-widest">
            DOS LECTURAS DEL PAISAJE
          </div>
          <p className="text-body text-white/50 leading-relaxed max-w-2xl mx-auto mt-6">
            Los dos proyectos observan el mismo territorio desde escalas complementarias: uno mediante las formas del relieve y otro mediante unidades ecológicas que integran componentes ambientales.
          </p>
        </Reveal>
